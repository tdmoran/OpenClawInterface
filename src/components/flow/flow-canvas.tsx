...
export function FlowCanvas() {
  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="relative h-[50vh] md:h-[calc(100vh-10rem)] w-full rounded-lg border bg-card">
        <ReactFlow
          nodes={nodes}
          edges={edges}
        ...
        {selectedNode && nodeData && (
          <div className="absolute inset-x-0 bottom-0 h-2/5 w-full border-t md:right-0 md:top-0 md:h-full md:w-80 md:border-l md:border-t-0 md:inset-x-auto bg-card p-4 shadow-lg overflow-auto">
